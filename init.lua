...
-- move line around
vim.keymap.set('n', '<A-j>', 'ddjP', { desc = 'Move down the line' })
vim.keymap.set('n', '<A-k>', 'ddkP', { desc = 'Move up the line' })
-- Diagnostic keymaps
...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      end, { desc = '[S]earch [A]ll' }) -- all files
